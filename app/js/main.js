...
var API_KEY = 'LDbcDCCHDGaBtep4EfndEuWHrLXLFccN8HT5cPKR';
...
var _artwork_model = require('./artwork_model');

var _artwork_model2 = _interopRequireDefault(_artwork_model);

var ArtCollection = _backbone2['default'].Collection.extend({
	url: 'https://api.parse.com/1/classes/Artwork',
	model: _artwork_model2['default'],
	parse: function parse(art) {
		return art.results;
	}
});
...
},{"./ajax_setup":1,"./router":6,"jquery":9,"moment":10,"underscore":11}],6:[function(require,module,exports){
'use strict';
...
var _artwork_collection = require('./artwork_collection');
...
var Router = _backbone2['default'].Router.extend({
	...
	showSpecificArt: function showSpecificArt(artId) {
		...
		if (specificArt) {
			this.$el.html((0, _specific_art2['default'])(specificArt.toJSON()));
		} else {
			(function () {
				var router = _this;
				...
				specificArt.fetch().then(function () {
					router.$el.html((0, _specific_art2['default'])(specificArt.toJSON()));
				});
			})();
		}
	},
...
},{"./artwork_collection":2,"./home":4,"./specific_art":7,"backbone":8,"jquery":9}],7:[function(require,module,exports){
'use strict';
